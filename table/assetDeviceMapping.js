  ...
  try {
    const query = `
        CREATE TABLE IF NOT EXISTS asset_device_mapping (
          ...
          s_ad_mp_pur	VARCHAR(20),
          asset_dvc_mp_dt	DATE,
          s_dvc_typ	VARCHAR(10),
          s_asset_id VARCHAR(10),
          s_asset_typ	VARCHAR(10),
          i_nw_imei_no VARCHAR(20),
          i_old_imei_no	VARCHAR(20),
          s_trk_typ	VARCHAR(10),
          s_old_sim_no VARCHAR(20),
          s_nw_sim_no	VARCHAR(20),
          s_sim_op VARCHAR(50),
          s_mx_spd INT,
          s_crct_spd INT,
